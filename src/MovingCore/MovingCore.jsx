...
const diagonalSpd = (speed) => speed / 2 ** (1 / 2);

const roundNumber = (num, index) => {
  const value = 10 ** index;
  return Math.round(num * value) / value;
};

const getSpeedComponents = (speed, direction) => {
  switch (direction) {
    case '➚':
